...
from isbn_harvester.core.checkpoint import CheckpointWriter, read_completed_tasks, task_id
from isbn_harvester.core.models import BookRow, TaskSpec
from isbn_harvester.core.normalize import build_shopify_tags
from isbn_harvester.core.parse import parse_book
from isbn_harvester.core.scoring import rank_score, jewish_relevance_score, fiction_flag, popularity_proxy
from isbn_harvester.core.stats_tracker import StatsTracker
from isbn_harvester.core.store import RowStore
from isbn_harvester.integrations.http_client import (
    TokenBucket,
    ISBNdbError,
    ISBNdbQuotaError,
    build_task_request,
...
def merge_row(existing: BookRow, new: BookRow, fiction_only: bool) -> BookRow:
    ...
    taxonomy_primary_genre = pick.taxonomy_primary_genre or existing.taxonomy_primary_genre
    taxonomy_jewish_themes = pick.taxonomy_jewish_themes or existing.taxonomy_jewish_themes
